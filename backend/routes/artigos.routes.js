...
// GET (Admin) - Buscar UM artigo pelo ID para o formulário de edição
...
// GET (Público) - Listar todos os artigos (paginado)
...
// GET (Público) - Buscar UM artigo pelo SLUG para a página pública
