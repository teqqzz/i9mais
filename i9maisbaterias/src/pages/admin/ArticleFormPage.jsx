...
export function ArticleFormPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = isEditing ? `${API_URL}/api/artigos/${id}` : `${API_URL}/api/artigos`;
        ...
        <div className="admin-card">
          <form onSubmit={handleSubmit} className="admin-form">
            ...
            <div className="form-actions">
              <button type="submit" className="admin-btn primary" disabled={loading}>{loading ? 'Salvando...' : 'Salvar Artigo'}</button>
